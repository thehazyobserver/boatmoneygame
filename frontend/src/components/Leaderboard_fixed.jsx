              ...
              {leaderboardData.map((player, index) => (
                ...
                >
                  ...
                  <td className="py-4 text-right">
                    <div className={`font-bold text-lg ${getNetProfitColor(player.netProfit)}`} style={{ fontFamily: 'Orbitron, monospace' }}>
                      {player.netProfit >= 0 ? '+' : ''}{formatNumber(player.netProfit)}
                    </div>
                    <div className="text-xs text-gray-400" style={{ fontFamily: 'Rajdhani, monospace' }}>
                      {selectedGame === 'BOAT' ? '$BOAT' : '$JOINT'}
                    </div>
                  </td>
                  <td className="py-4 text-right">
